			...
			<xsl:for-each select="Operation">
				...
				<tr class="{$classtype}">
					...
					<xsl:if test="$hasParameters='true'">
						<td/>
						<tr class="{$classtype}">
						<td valign="top" align="left" width="20%" class="mbean_parameter_row">
						...
						<td colspan="2">
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tr class="{$classtype}">
									<td width="4%" class="mbean_parameter_row">
									...
									<td width="18%" class="mbean_parameter_row">
									...
									<td width="50%" class="mbean_parameter_row">
